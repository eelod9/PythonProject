...
class QuizInterface:
    def __init__(self,quiz_brain:QuizBrain):
        ...
        self.question_text = self.canvas.create_text(
            150, 125,width = 280, text= "question text",fill = THEME_COLOR,font=("Arial",20,"italic"))
        self.canvas.grid(row=1,column=0,columnspan=2,pady = 50)

        
        #Buttons
        true_image = PhotoImage(file = "./QuizAPI/images/true.png" )
        self.true_button = Button(image=true_image,highlightthickness=0,command=self.sendTrue)
        self.true_button.grid(row=2, column=0)

        false_image = PhotoImage(file = "./QuizAPI/images/false.png" )
